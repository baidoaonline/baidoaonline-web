    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .article-meta { font-size: 13px; color: #888; margin-bottom: 20px; display: flex; gap: 12px; flex-wrap: wrap; }
        ...
        .back-link { display: inline-flex; align-items: center; gap: 6px; color: #cc0000; font-size: 13px; font-weight: 700; margin-bottom: 24px; }
