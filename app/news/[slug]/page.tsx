...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const description = post.metaDescriptionEn || post.titleEn || post.title || 'Latest news from Baidoa and Somalia'
  return {
    title,
    description,
    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .article-meta { font-size: 13px; color: #888; margin-bottom: 0; display: flex; gap: 20px; flex-wrap: wrap; align-items: center; padding-bottom: 12px; border-bottom: 1px solid #eee; font-family: sans-serif; letter-spacing: 0.3px; }
        ...
        @media (max-width: 600px) {
          ...
          .article-img { max-height: 320px; object-fit: cover; object-position: center center; }
        }
      `}</style>
