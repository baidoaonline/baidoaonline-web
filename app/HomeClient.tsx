    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .blink-dot { width:18px; height:18px; border-radius:50%; border:2.5px solid #cc0000; display:inline-flex; align-items:center; justify-content:center; flex-shrink:0; position:relative; animation:blink 1s ease-in-out infinite; }
        .blink-dot::before { content:''; width:8px; height:8px; background:#cc0000; border-radius:50%; }
        .blink-dot::after { content:''; position:absolute; inset:-4px; border-radius:50%; border:2px solid #cc0000; animation:ripple 1.3s ease-out infinite; }
        .hero-breaking-badge { position:absolute; top:18px; left:18px; background:#fff; color:#cc0000; padding:6px 14px 6px 10px; font-size:12px; font-weight:900; border-radius:4px; letter-spacing:1.5px; display:flex; align-items:center; gap:8px; box-shadow:0 2px 8px rgba(0,0,0,0.3); }
